                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="top-button">
                                ...
                                <a href="<?php echo U('Notes/index',array('cid'=>$cid,'p'=>$p));?>" class="light">返回博客列表</a>
                            </div>
                            ...
                            <form method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="name" class="form-control" value="<?php echo ($notes["name"]); ?>" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="sn" class="form-control" value="<?php echo ($notes["sn"]); ?>" >
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="desc" class="form-control" value="<?php echo ($notes["desc"]); ?>">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="keywords" class="form-control" value="<?php echo ($notes["keywords"]); ?>">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div>
                                    <textarea name="code" id="code" class="codeshow"><?php echo ($notes["code"]); ?></textarea>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <?php if(empty($notes["thumb"])): ?><img src="/Public/Common/img/preview.jpg">
                                        <?php else: ?>
                                            <img src="<?php echo ($notes["thumb"]); ?>"><?php endif; ?>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="editor" >
...
<script>
    ...
    "initialFrameWidth":"100%" //初始化选项
                                    ...
                                    <script type="text/plain" id="myEditor" name="content"><?php echo ($notes["content"]); ?></script>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">站内链接：</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="links" class="form-control" value="<?php echo ($notes["links"]); ?>">
                                        <span class="help-block m-b-none">格式如：“Notes/notes/id/num”</span>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        <button class="btn btn-primary" type="submit" value="添加博客">保存内容</button>
    ...
    <script>
        ...
        $("#category").change(function(){
            var url = "<?php echo U('Notes/edit',array('id'=>$id,'cid'=>'_ID_','p'=>$p));?>";
