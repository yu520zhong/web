...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row  border-bottom white-bg dashboard-header min-ht550">
                <div class="col-sm-12">
                    <h3>服务器信息（默认显示）<span class="label label-primary">新</span></h3>
                    <p>以下是具体信息</p>
                    <p>
                        <span class="simple_tag">系统环境：<?php echo ($serverInfo["server_version"]); ?></span>
                    </p>
                    <p>
                        <span class="simple_tag">服务器时间：<?php echo ($serverInfo["server_time"]); ?></span>
                    </p>
                    <p>
                        <span class="simple_tag">MySQL版本：<?php echo ($serverInfo["mysql_version"]); ?></span>
                    </p>
                    <p>
                        <span class="simple_tag">文件上传限制：<?php echo ($serverInfo["max_upload"]); ?></span>
                    </p>
                    <p>
                        <span class="simple_tag">脚本执行时限：<?php echo ($serverInfo["max_ex_time"]); ?></span>
                    </p>
                    <br>
                    <p>
                        <a class="btn btn-success btn-outline" href="http://wpa.qq.com/msgrd?v=3&amp;uin=2211735722&amp;site=qq&amp;menu=yes" target="_blank">
                            <i class="fa fa-qq"> </i> 联系我
                        </a>
                        <a class="btn btn-white btn-bitbucket" href="http://www.macyu.cn/" target="_blank">
