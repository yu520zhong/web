                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="top-button">
                            相关操作：<a href="<?php echo U('Categoryart/index');?>" class="light">文章分类列表</a>
                        </div>
                            ...
                            <form method="post" class="form-horizontal" enctype="multipart/form-data">
                                <div class="top-button">
                                    ...
                                    <select name="pid" class="form-control">
                                        ...
                                        <?php if(is_array($categoryart)): foreach($categoryart as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if(($v["id"]) == $pid): ?>selected<?php endif; ?>><?php echo str_repeat('/ ',$v['level']); echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        <button class="btn btn-primary" type="submit" value="修改分类">修改分类</button>
                                        <button class="btn btn-white" type="reset" value="重新填写" name="return">重新填写</button>
                                    </div>
                                </div>
                            </form>
                        </div>
