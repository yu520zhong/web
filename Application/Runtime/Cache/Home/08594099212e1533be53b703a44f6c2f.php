...
<meta name="keywords" content="开发工具，常用导航，觅友，觅友网，觅友博客，觅友小站，前端，miuu,IT开发，css，css3，js，js特效，php，jquery，ajax，java">
...
<section class="focusbox">
    <div class="container">
        <h1 class="focusbox-title">常用导航</h1>
        <div class="focusbox-text">收集了一些自己常用的导航，并分门别类，便于快速导航。</div>
    </div>
</section>
<!--container start-->
<div class="content">
<div class="container space30">
    <div class="row">
            ...
            <div class="content-wrap">
                <div class="content">
                    <?php if(is_array($navs)): $i = 0; $__LIST__ = $navs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="navs-box"><h2><a href="/blogs/0"><?php echo ($v["name"]); ?></a></h2>
                            <ul>
                                <?php if(is_array($v['navs'])): $i = 0; $__LIST__ = $v['navs'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($sub["url"]); ?>" target="_blank"><?php echo ($sub["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
        ...
        <div class="col-md-4 sidebar">
            ...
            <div class="navs-widget widget-b-list">
                <?php if(is_array($blog)): $i = 0; $__LIST__ = $blog;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><h4><?php echo ($v["name"]); ?></h4>
                    <ul>
                        <?php if(is_array($v['navs'])): $i = 0; $__LIST__ = $v['navs'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($sub["url"]); ?>" target="_blank"><?php echo ($sub["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
            ...
            <div class="widget widget-posts" >
                <a href="#" target="_blank" rel="nofollow"><img src="http://7xsqlc.com1.z0.glb.clouddn.com/banner/small-7.jpg" class="full-img"></a>
            </div>
