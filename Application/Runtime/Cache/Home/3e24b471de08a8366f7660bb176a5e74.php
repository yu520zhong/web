    ...
    <div class="container space30">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="col-md-12">
                    <?php if(empty($news["data"])): ?><p class="no_find">很抱歉，此分类暂无文章!</p><?php else: ?>
                        <?php if(is_array($news["data"])): foreach($news["data"] as $key=>$v): ?><article class="excerpt excerpt-text">
                                <div class="excerpt-news">
                                    <h2 class="title">
                                        <a href="javascript:void(0)" target="_blank" title="<?php echo ($v["name"]); ?>"><?php echo ($v["name"]); ?></a>
                                    </h2>
                                    <div class="news-content"><?php echo ($v["content"]); ?></div>
                                    <ul class="list-inline news-tips mt15">
...
//筛选列表，分类的当前选中效果
<?php if(is_array($categorynews["pids"])): foreach($categorynews["pids"] as $key=>$v): ?>$(".cid-<?php echo ($v); ?>").addClass("curr");<?php endforeach; endif; ?>
</script>
</body>
</html>