...
<section class="focusbox">
    <div class="container">
        <h1 class="focusbox-title">历史的今天</h1>
        <div class="focusbox-text">回顾历史的长河，历史是生活的一面镜子！</div>
    </div>
</section>
<!--container start-->
<div class="content">
    <div class="container space30">
        <div class="row">
            ...
            <div class="col-md-8 wow fadeInUp animated">
                <div class="excerpt excerpt-text">
                    <div class="event">
                        <ul class="timeline">

                            <?php if(is_array($history)): foreach($history as $key=>$v): ?><li>
                                    <div class="event-time"><?php echo ($v["year"]); ?>年</div>
                                    <div class="event-title"><?php echo ($v["des"]); ?></div>
                ...
                <div class="blog-comments mtop15">
                    ...
                    <div id="cyEmoji" role="cylabs" data-use="emoji" sid="006"></div>
                    ...
                    <!-- 畅言评论框 start -->
                    <div id="SOHUCS" sid="006"></div>
                    <!-- 畅言评论框 end -->
                </div>
            </div>
           <div class="col-md-4 sidebar wow fadeInUp animated">
...
<!-- <script type="text/javascript">
    $(function(){
        $.ajax({
            ...
            url : ThinkPHP['MODULE'] + '/History/history',
            success : function (data, response, status) {
                var event = data.result, item;
                var temp = "";
                var ary = [];
                for (var j in event) {
                    ary.push(event[j]);
