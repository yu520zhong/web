...
<!-- revolution slider start -->
    <div class="focusbox">
            <div class="container">
            <h1 class="focusbox-title">常用软件</h1>
            ...
            <div class="col-md-8 single">
                ...
                <div class="content">
                    <header class="article-header">
                        <h1 class="article-title"><a href="#"> <?php echo ($down["name"]); ?></a>
                        </h1>
                        <div class="article-meta">
                                <span class="item"><i class="miuu u-rili"></i> <?php echo ($down["add_time"]); ?></span>
                                <span class="item"><i class="miuu u-qunzu"></i> 所属：<?php echo ($down["author"]); ?></span>
                                <span class="item post-views"><i class="miuu u-xiazai"></i> 下载(<?php echo ($down["click"]); ?>)</span>
                                <span class="item">
                                    <a class="digest-label-link" href="<?php echo downmkFilterURL('cid',$vv['id']);?>" target="_blank"><?php echo ($v["category_name"]); ?></a>
                                </span>
                        </div>
                    </header>

                    <article class="article-content">
                            <?php if(!empty($down["thumb"])): ?><p class="text-center">
                                    <img class="alignnone size-full wp-image-74" src="<?php echo ($down["thumb"]); ?>">
                                </p>
                                <?php else: endif; ?>
                            <?php echo ($down["content"]); ?>
                        <p class="post-copyright">本资源系互联网收集，版权归原组织所有，转载请注明出处：<?php if(is_array($path)): foreach($path as $key=>$v): ?>&nbsp;
                                <a href="<?php echo U('Down/index',array('cid'=>$v['id']));?>">
                                    <?php echo ($v["name"]); ?>
                                </a>
                    ...
                    <div class="post-linkto text-center"><a class="btn btn-success btn-lg" href="<?php echo ($down["url"]); ?>"
                                                target="_blank" >下载链接</a></div>
                    ...
                    <ul class="pager clearfix">
                        <?php if(empty($prev)): else: ?>
                            <li class="previous">
                                <a title="<?php echo ($prev["name"]); ?>" href="<?php echo U('Down/down',array('id'=>$prev['id']));?>" data-toggle="tooltip" data-original-title="<?php echo ($prev["name"]); ?>">上一篇</a>
                            </li><?php endif; ?>
                        <?php if(empty($next)): else: ?>
                            <li class="next">
                                <a title="<?php echo ($next["name"]); ?>" href="<?php echo U('Down/down',array('id'=>$next['id']));?>" data-toggle="tooltip" data-original-title="<?php echo ($next["name"]); ?>">下一篇</a>
                            </li><?php endif; ?>
                    </ul>
                    ...
                    <div class="relates">
                        ...
                        <ul>
                            <?php if(is_array($recommend["data"])): foreach($recommend["data"] as $key=>$v): ?><li>
                                    <a href="<?php echo U('Down/down',array('id'=>$v['id']));?>"><?php echo ($v["name"]); ?></a>
                ...
                <div class="blog-comments mtop15">
                    <!-- 畅言评论框 start -->
                    <div id="SOHUCS" sid="003<?php echo ($down["id"]); ?>"></div>
                    <!-- 畅言评论框 end -->
                </div>
            </div>
