    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="bs-docs-section">
                ...
                <p class="lead">Bootstrap（当前版本
                    v3.3.7）提供以下几种方式帮你快速上手，每一种方式针对具有不同技能等级的开发者和不同的使用场景。继续阅读下面的内容，看看哪种方式适合你的需求吧。</p>
            </div>

            <div class="bs-docs-section">
                <h1 id="whats-included" class="page-header">包含的内容
                </h1>
                ...
                <h2 id="whats-included-precompiled">预编译版
                </h2>
...
<script src="https://cdn.bootcss.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script></pre>
                ...
                <h2 id="whats-included-source">Bootstrap
                    源码</h2>
			...
			<div style="margin-bottom: 30px;">
            	...
            	<div class="content">
                    <ul class="pager clearfix">
                            <li class="previous"><a href="<?php echo U('Blog/articles',array('id'=>$prev['id']));?>" class="tooltip-test" data-toggle="tooltip" title="默认的 Tooltip">默认的 Tooltip</a></li>
                            <li class="next"><a href="<?php echo U('Blog/articles',array('id'=>$prev['id']));?>" class="tooltip-test" data-toggle="tooltip" title="默认的 Tooltip">默认的 Tooltip</a></li>
                    </ul>
