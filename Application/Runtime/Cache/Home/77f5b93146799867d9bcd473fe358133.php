...
<section class="focusbox">
    <div class="container">
        <h1 class="focusbox-title">小工具</h1>
        <div class="focusbox-text">常言道:工欲善其事必先利器。好工具是让编程更轻松更顺利的保障,当然，适当休闲娱乐也是必不可少滴！</div>
    </div>
</section>
...
<div class="container space30">
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <table class="table table-bordered table-tools tbox">
                <tr>
                    <td>
                        <h4>代码比较工具</h4>
                        <p>可实现代码对比演示功能（推荐）</p>
                        <a class="btn btn-sm btn-default" href="<?php echo U('Tools/mergely');?>">查看演示</a>
                    </td>
                    <td>
                        <h4>代码演示工具</h4>
                        <p>可实现代码实时演示功能</p>
                        <a class="btn btn-sm btn-default" href="<?php echo U('Tools/showcode');?>">查看演示</a>
                    </td>
                    <td>
                        <h4>JS/HTML格式化工具</h4>
                        <p>简单易用的JS/HTML格式化工具</p>
                        <a class="btn btn-sm btn-default" href="<?php echo U('Tools/jsformat');?>">查看演示</a>
                    </td>
                    <td>
                        <h4>CSS代码格式化工具</h4>
                    <p>可实现CSS代码格式化和CSS在线压缩</p>
                    <a class="btn btn-sm btn-default" href="<?php echo U('Tools/cssformat');?>">查看演示</a>
                    </td>
                </tr>
                <tr>
                    <td>
