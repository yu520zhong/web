...
<title>觅友_有朋自远方来-全站搜索</title>
<meta name="keywords" content="觅友，觅友网，觅友博客，觅友小站，前端，miuu,IT开发，css，css3，js，js特效，php，jquery，ajax，java">
<meta name="description" content="小鱼说，是小鱼的个人网站，致力于收集整理互联网前沿的开发技术，分享自己网站开发学习以及工作和生活中的点点滴滴，希望通过此网站，与大家一起交流、成长、进步！">
...
<script src="/web/Public/Home/plugins/laypage/laypage/laypage.js"></script>
<script type="text/javascript">
    var url_ajax = "/web/Other/orders";
    var host = '/web/';
    $(function() {
                ...
                var thisDate = function(curr){
                    ...
                    for(var i = (curr*nums - nums); i <= last; i++){
                        str += '<article class="excerpt excerpt-text">'
                            ...
                            +             '<li>'
                            +           '<i class="miuu u-rili"></i> '
                            +                 data[i]['add_time']
                            +             '</li>'
                            +             '<li class="pv">'
                            +               '<i class="miuu u-eyes"></i> '
                            +                 '阅读'
                            +               '('
                            +               data[i]['click']
                            +               ')'
