                        ...
                        <?php if(!empty($articles["data"])): if(is_array($articles["data"])): foreach($articles["data"] as $key=>$v): ?><article class="excerpt excerpt-text">
                                    <div class="row">
                                        <header class="col-md-8">
                                            ...
                                            <div class="blog-desc">
                                                <?php echo (truncate_cn($v["content"],160,'...',0)); ?>
                                            </div>
                                        </header>
                                        <div class="col-md-4">
                                            <a href="#" class="nail">
...
<div class="footer-bottom">
    <div class="container">
        <div class="copyrights">
            <p>Copyright &copy; 2017.Company name All rights reserved.<a target="_blank" href="">觅友网</a> - More About <a href="" target="_blank" title="关于我">关于我</a></p>
        </div>
    </div>
</div>
<a href="#" id="toTop"></a>
