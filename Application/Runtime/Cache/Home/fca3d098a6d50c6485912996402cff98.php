...
<title><?php echo ($keyword); ?>_觅友</title>
...
<link rel="stylesheet" type="text/css" href="/web/Public/Home/plugins/IonCalendar/css/ion.calendar.css">
<link rel="stylesheet" href="/web/Public/Home/css/index.css" />
<link rel="stylesheet" href="/web/Public/Home/plugins/slick/css/slick.css">
<link rel="stylesheet" href="/web/Public/Home/plugins/slick/css/slick-set.css">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-8">
                            <div class="search-pre" id="search">
                                <input type="text" name="keywords" id="word" value="" class="search-ipt" placeholder="请输入关键词" autocomplete="off">
                                <ul id="list"></ul>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="submit" id="home" value="技术文摘" class="search-btn-pre search-btn-blue">
                                </div>
                                <div class="col-md-6">
                                    <a href="http://www.baidu.com/s?word=" target="_blank" >
                                        <input type="submit" id="netWork" value="百度搜索" class="search-btn-pre search-btn-grey">
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="content">
                    <section class="article">
                        <?php if(!empty($articles["data"])): if(is_array($articles["data"])): foreach($articles["data"] as $key=>$v): ?><article class="excerpt excerpt-text">
                                <div class="row">
                                    <div class="col-md-4">
                                        <a href="<?php echo U('Blog/articles',array('id'=>$v['id']));?>" class="nail">
                                            <img src="<?php echo ($v["thumb"]); ?>" alt="入手React+Redux开发，是应该先写逻辑，还是先写UI呢?" class="thumb">
                                        </a>
                                    </div>
                                    <header class="col-md-8">
                                        <div class="excerpt-content">
                                            <h2 class="title">
                                                <a href="<?php echo U('Blog/articles',array('id'=>$v['id']));?>" target="_blank" title="入手React+Redux开发，是应该先写逻辑，还是先写UI呢?"><?php echo ($v["name"]); ?></a>
                                            </h2>
                                            ...
                                            <p class="note"><?php echo (truncate_cn($v["content"],160,'...',0)); ?></p>
                                        </div>
                                    </header>
                                </div>
                            ...
                            <?php else: ?>
                            对不起，您搜索的<strong class="red"><?php echo ($keyword); ?></strong>没有相关内容！<?php endif; ?>
                    </section>
                </div>
            </div>
        </div>
