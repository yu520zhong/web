...
class LunarHelp {
  constructor(year,month,day) {
    ...
    //计算年数
    for (i = 1900; i < 2150 && (offset-this.lYearDays(i)) > 0; i++) {
...
SimpleCalendar.prototype.languageData = {
  ...
  vocation: {
    ...
    data_2017: ['1-1', '1-2', '1-27','1-28','1-29','1-30','1-31', '2-1', '2-2', '4-2', '4-3', '4-4', '4-29','4-30','5-1', '5-28','5-29','5-30', '10-1', '10-2', '10-3', '10-4', '10-5', '10-6', '10-7', '10-8']
  },
}
